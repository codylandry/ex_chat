defmodule ExChatDal.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ExChatDal.Repo)
  ...
  """
  def valid_password?(%ExChatDal.Accounts.User{hashed_password: hashed_password}, password)
